      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-12">
          <div>
            ...
            <a href="https://wa.me/212773857905" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm text-[#1eab54] hover:text-[#25D366] transition-colors font-medium">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5 -.669 -.51 -.173 -.008 -.371 -.01 -.57 -.01 -.198 0 -.52 .074 -.792 .372 -.272 .297 -1.04 1.0１６ -１．０４ ２．４７９ ０ １．４６２ １．０６５ ２．８７５ １．２１３ ３．０７４ .１４９ .１９８ ２．０９６ ３．２ ５．０７７ ４．４８７ .７０９ .３０６ １．２６２ .４８９ １．６９４ .６２５ .７１２ .２２７ １．３６ .１９５ １．８７１ .１１８ .５７１ -.０８５ １．７５８ -.７１９ ２．００６ -₁.₄₁₃ .₂₄₈ -.₆₉₄ .₂₄₈ -₁.₂₈₉ .₁₇₃ -₁.₄₁₃ -.₀₇₄ -.₁₂₄ -.₂₇₂ -.₁₉₈ -.៥₇ -." /></svg>
              +212 773 857 905
            </a>
          </div>
          <div>
...
function OrderModal({ open, initialModel, initialPlan, onClose }: { open: boolean; initialModel: number | null; initialPlan: string; onClose: () => void }) {
  ...
  const handleWhatsAppOrder = () => {
    ...
    window.open(`https://wa.me/212773857905?text=${message}`, '_blank', 'noopener,noreferrer')
  }
